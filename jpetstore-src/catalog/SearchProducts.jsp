...
<logic:iterate id="product" name="productList" >
  ...
  <logic:notEqual name="productList" property="firstPage" value="true" >
    <a href="switchSearchListPage.shtml?pageDirection=previous"><img src="../images/button_prev.gif" border="0"></a>
  </logic:notEqual>
  <logic:notEqual name="productList" property="lastPage" value="true" >
    <a href="switchSearchListPage.shtml?pageDirection=next"><img src="../images/button_next.gif" border="0"></a>
  </logic:notEqual>
  </td>
  </tr>
